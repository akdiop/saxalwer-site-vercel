...
const content = {
  fr: {
    ...
    problem: {
      ...
      intro: "Au Sénégal, comme dans de nombreux pays d'Afrique subsaharienne, les questions liées à la santé sexuelle et reproductive sont entourées de silence.",
      items: [
        { icon: '🔇', title: 'Le tabou social', text: "Parler de son cycle, d'une douleur intime ou d'une grossesse est souvent perçu comme inapproprié. Les femmes se retrouvent seules face à des questions vitales." },
